            ...
            <div class="row">
                ...
                <div class="card col-lg-12" style="padding:0px;">
                    <div class="card-header">
                        <span class="title-3 m-l-30"><i class="fa fa-user"></i> Edit Vendor</span>
                        ...
                        <form class="form-horizontal" id="userform" attr_id="<?php echo $user['id'];?>" attr_type="<?php echo $user['usertype'];?>">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-sm-6 col-md-8 col-lg-8 col-xs-12">
                                    <textarea class="form-control" name="description"rows="5" required><?php echo $user['description'];?></textarea>
                                </div>
