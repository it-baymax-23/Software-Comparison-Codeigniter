                ...
                <div class="row">
                    <div class="user-data col-lg-12 m-b-20">
                    	<div class="portlet box green">
                    		<h3 class="title-3 m-b-20" style="padding-left: 5px; padding-right: 5px; font-size: 20px; font-weight: bold;"><i class="fa fa-users"></i>All Admins</h3>
                            <div class="filters m-b-0" style="padding-left: 5px; padding-right: 5px;">
                                <a href="<?php echo base_url();?>admin/user/newuser/admin" id="add_new_user" class="btn btn-success" style="border-radius: 20px; ">
                                                    ...
                                                    <ul class="dropdown-menu pull-right account-dropdown__body" role="menu">
                                                        <div class="account-dropdown__body">
                                                            <div class="account-dropdown__item">
                                                                <a href="<?php echo base_url();?>admin/user/edituser/admin/<?php echo $users['id'];?>" style="font-size: 12px;">
